    ...
    def calcular(dados, componente, componentes_adicionais=None):
        ...
        if componentes_adicionais:
            for comp in componentes_adicionais:
                ...
                if codigo_tipo and codigo_tipo in LateralSimplesRule.CALCULADORAS_ADICIONAIS:
                    funcao_calculo = LateralSimplesRule.CALCULADORAS_ADICIONAIS[codigo_tipo]
        ...
        return {
            ...
            'resumo': f"{quantidade}x laterais de {altura}cm x {largura}cm = {resultado_mdf['quantidade_utilizada']} m²"
        }